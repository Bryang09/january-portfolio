      ...
      <div className="intPara">
        <div className="paragraph">
          ...
          <h4>
            ...
            endless adventures to finding an answer, that frankly, aren't all
            that complicated. However, I believe this is what allowed me to grow
            not only as a developer, but as a person as well.
          </h4>
        </div>
        <div className="paragraph">
